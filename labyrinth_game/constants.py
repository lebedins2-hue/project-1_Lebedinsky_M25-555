...
ROOMS = {
    'entrance': {
        'description': ('Вы в темном входе лабиринта. Стены покрыты ' 
    ...
    'library': {
          ...
          'items': ['ancient_book'],
          'puzzle': [('В одном свитке загадка: "Что растет, ' 
                      'когда его съедают?" (ответ одно слово)'), 'резонанс']
    },
        'armory': {
    ...
    'treasure_room': {
          ...
          'exits': {'south': 'hall','west': 'dining_room'},
    ...
    'throne_room': {
          'description': 
                  'Большая комната с троном по центру. '
                  'На подлокотнике трона отверстие для установки грааля.',
